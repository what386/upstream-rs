...
complete -c upstream -n "__fish_upstream_needs_command" -f -a "docs" -d 'Search package README documentation'
...
complete -c upstream -n "__fish_upstream_needs_command" -f -a "import" -d 'Import config, trusted keys, or exported packages'
complete -c upstream -n "__fish_upstream_needs_command" -f -a "export" -d 'Export config, trusted keys, or installed package references'
...
complete -c upstream -n "__fish_upstream_using_subcommand rollback" -l prune -d 'Prune stored rollback artifacts for all packages or selected package names' -r
complete -c upstream -n "__fish_upstream_using_subcommand rollback" -l list -d 'List stored rollback artifacts'
...
complete -c upstream -n "__fish_upstream_using_subcommand docs" -l fetch -d 'Refresh cached README docs for named packages, or all packages when no names are provided' -r
...
complete -c upstream -n "__fish_upstream_using_subcommand docs" -s y -l yes -d 'Accept confirmation prompts'
...
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin rename add-entry rm-entry help" -s y -l yes -d 'Accept confirmation prompts'
...
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin rename add-entry rm-entry help" -f -a "pin" -d 'Pin a package to its current version'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin rename add-entry rm-entry help" -f -a "unpin" -d 'Unpin a package to allow updates'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin rename add-entry rm-entry help" -f -a "rename" -d 'Rename package alias without reinstalling'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin rename add-entry rm-entry help" -f -a "add-entry" -d 'Create desktop launcher integration for an installed package'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin rename add-entry rm-entry help" -f -a "rm-entry" -d 'Remove desktop launcher integration for an installed package'
...
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from add-entry" -s y -l yes -d 'Accept confirmation prompts'
...
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from rm-entry" -s y -l yes -d 'Accept confirmation prompts'
...
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from help" -f -a "add-entry" -d 'Create desktop launcher integration for an installed package'
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from help" -f -a "rm-entry" -d 'Remove desktop launcher integration for an installed package'
...
complete -c upstream -n "__fish_upstream_using_subcommand import; and not __fish_seen_subcommand_from config keys packages profile help" -s y -l yes -d 'Accept confirmation prompts'
...
complete -c upstream -n "__fish_upstream_using_subcommand import; and not __fish_seen_subcommand_from config keys packages profile help" -f -a "config" -d 'Import upstream config'
...
complete -c upstream -n "__fish_upstream_using_subcommand import; and not __fish_seen_subcommand_from config keys packages profile help" -f -a "packages" -d 'Import and install packages from an upstream packages export'
complete -c upstream -n "__fish_upstream_using_subcommand import; and not __fish_seen_subcommand_from config keys packages profile help" -f -a "profile" -d 'Import config, keys, and packages from an upstream profile export'
...
complete -c upstream -n "__fish_upstream_using_subcommand import; and __fish_seen_subcommand_from config" -s y -l yes -d 'Accept confirmation prompts'
...
complete -c upstream -n "__fish_upstream_using_subcommand import; and __fish_seen_subcommand_from keys" -s y -l yes -d 'Accept confirmation prompts'
...
complete -c upstream -n "__fish_upstream_using_subcommand import; and __fish_seen_subcommand_from packages" -l skip-failed -d 'Continue importing remaining packages when one package fails'
complete -c upstream -n "__fish_upstream_using_subcommand import; and __fish_seen_subcommand_from packages" -l latest -d 'Ignore stored version tags and install the latest release'
complete -c upstream -n "__fish_upstream_using_subcommand import; and __fish_seen_subcommand_from packages" -s y -l yes -d 'Accept confirmation prompts'
...
complete -c upstream -n "__fish_upstream_using_subcommand import; and __fish_seen_subcommand_from profile" -l skip-failed -d 'Continue importing remaining packages when one package fails'
complete -c upstream -n "__fish_upstream_using_subcommand import; and __fish_seen_subcommand_from profile" -l latest -d 'Ignore stored package version tags and install latest releases'
complete -c upstream -n "__fish_upstream_using_subcommand import; and __fish_seen_subcommand_from profile" -s y -l yes -d 'Accept confirmation prompts'
...
complete -c upstream -n "__fish_upstream_using_subcommand import; and __fish_seen_subcommand_from help" -f -a "config" -d 'Import upstream config'
...
complete -c upstream -n "__fish_upstream_using_subcommand import; and __fish_seen_subcommand_from help" -f -a "packages" -d 'Import and install packages from an upstream packages export'
complete -c upstream -n "__fish_upstream_using_subcommand import; and __fish_seen_subcommand_from help" -f -a "profile" -d 'Import config, keys, and packages from an upstream profile export'
...
complete -c upstream -n "__fish_upstream_using_subcommand export; and not __fish_seen_subcommand_from config keys packages profile help" -s y -l yes -d 'Accept confirmation prompts'
...
complete -c upstream -n "__fish_upstream_using_subcommand export; and not __fish_seen_subcommand_from config keys packages profile help" -f -a "config" -d 'Export upstream config'
...
complete -c upstream -n "__fish_upstream_using_subcommand export; and not __fish_seen_subcommand_from config keys packages profile help" -f -a "packages" -d 'Export installed package references'
complete -c upstream -n "__fish_upstream_using_subcommand export; and not __fish_seen_subcommand_from config keys packages profile help" -f -a "profile" -d 'Export config, trusted keys, and installed package references'
...
complete -c upstream -n "__fish_upstream_using_subcommand export; and __fish_seen_subcommand_from config" -s y -l yes -d 'Accept confirmation prompts'
...
complete -c upstream -n "__fish_upstream_using_subcommand export; and __fish_seen_subcommand_from keys" -s y -l yes -d 'Accept confirmation prompts'
...
complete -c upstream -n "__fish_upstream_using_subcommand export; and __fish_seen_subcommand_from packages" -s y -l yes -d 'Accept confirmation prompts'
...
complete -c upstream -n "__fish_upstream_using_subcommand export; and __fish_seen_subcommand_from profile" -s y -l yes -d 'Accept confirmation prompts'
...
complete -c upstream -n "__fish_upstream_using_subcommand export; and __fish_seen_subcommand_from help" -f -a "config" -d 'Export upstream config'
...
complete -c upstream -n "__fish_upstream_using_subcommand export; and __fish_seen_subcommand_from help" -f -a "packages" -d 'Export installed package references'
complete -c upstream -n "__fish_upstream_using_subcommand export; and __fish_seen_subcommand_from help" -f -a "profile" -d 'Export config, trusted keys, and installed package references'
...
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog docs probe search find config package hooks import export doctor help" -f -a "install" -d 'Install a package from an upstream release source'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog docs probe search find config package hooks import export doctor help" -f -a "build" -d 'Build and install from source for release tags without artifacts'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog docs probe search find config package hooks import export doctor help" -f -a "remove" -d 'Remove one or more installed packages'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog docs probe search find config package hooks import export doctor help" -f -a "rollback" -d 'Manage stored rollback artifacts'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog docs probe search find config package hooks import export doctor help" -f -a "reinstall" -d 'Reinstall one or more packages (remove then install)'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog docs probe search find config package hooks import export doctor help" -f -a "upgrade" -d 'Upgrade installed packages to their latest versions'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog docs probe search find config package hooks import export doctor help" -f -a "list" -d 'List installed packages and their metadata'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog docs probe search find config package hooks import export doctor help" -f -a "changelog" -d 'Show upstream release notes for an installed package'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog docs probe search find config package hooks import export doctor help" -f -a "docs" -d 'Search package README documentation'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog docs probe search find config package hooks import export doctor help" -f -a "probe" -d 'Probe a repository/source, choose an asset, and install it'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog docs probe search find config package hooks import export doctor help" -f -a "search" -d 'Search provider repositories by keyword(s)'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog docs probe search find config package hooks import export doctor help" -f -a "find" -d 'Search repositories interactively and install a selected result'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog docs probe search find config package hooks import export doctor help" -f -a "config" -d 'Manage upstream configuration'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog docs probe search find config package hooks import export doctor help" -f -a "package" -d 'Manage package-specific behavior'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog docs probe search find config package hooks import export doctor help" -f -a "hooks" -d 'Manage shell integration hooks and local upstream data'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog docs probe search find config package hooks import export doctor help" -f -a "import" -d 'Import config, trusted keys, or exported packages'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog docs probe search find config package hooks import export doctor help" -f -a "export" -d 'Export config, trusted keys, or installed package references'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog docs probe search find config package hooks import export doctor help" -f -a "doctor" -d 'Run diagnostics to detect installation and integration issues'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog docs probe search find config package hooks import export doctor help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c upstream -n "__fish_upstream_using_subcommand help; and __fish_seen_subcommand_from package" -f -a "add-entry" -d 'Create desktop launcher integration for an installed package'
complete -c upstream -n "__fish_upstream_using_subcommand help; and __fish_seen_subcommand_from package" -f -a "rm-entry" -d 'Remove desktop launcher integration for an installed package'
...
complete -c upstream -n "__fish_upstream_using_subcommand help; and __fish_seen_subcommand_from import" -f -a "config" -d 'Import upstream config'
...
complete -c upstream -n "__fish_upstream_using_subcommand help; and __fish_seen_subcommand_from import" -f -a "packages" -d 'Import and install packages from an upstream packages export'
complete -c upstream -n "__fish_upstream_using_subcommand help; and __fish_seen_subcommand_from import" -f -a "profile" -d 'Import config, keys, and packages from an upstream profile export'
complete -c upstream -n "__fish_upstream_using_subcommand help; and __fish_seen_subcommand_from export" -f -a "config" -d 'Export upstream config'
...
complete -c upstream -n "__fish_upstream_using_subcommand help; and __fish_seen_subcommand_from export" -f -a "profile" -d 'Export config, trusted keys, and installed package references'
