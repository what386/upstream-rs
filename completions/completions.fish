...
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list probe config package hooks import export doctor help" -f -a "remove" -d 'Remove one or more installed packages'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list probe config package hooks import export doctor help" -f -a "reinstall" -d 'Reinstall one or more packages (remove then install)'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list probe config package hooks import export doctor help" -f -a "upgrade" -d 'Upgrade installed packages to their latest versions'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list probe config package hooks import export doctor help" -f -a "list" -d 'List installed packages and their metadata'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list probe config package hooks import export doctor help" -f -a "probe" -d 'Inspect releases visible from a provider without installing'
