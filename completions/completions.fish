...
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin get-key set-key rename metadata help" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin get-key set-key rename metadata help" -f -a "pin" -d 'Pin a package to its current version'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin get-key set-key rename metadata help" -f -a "unpin" -d 'Unpin a package to allow updates'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin get-key set-key rename metadata help" -f -a "get-key" -d 'Get specific package metadata fields'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin get-key set-key rename metadata help" -f -a "set-key" -d 'Manually set package metadata fields'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin get-key set-key rename metadata help" -f -a "rename" -d 'Rename package alias without reinstalling'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin get-key set-key rename metadata help" -f -a "metadata" -d 'Display all metadata for a package'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin get-key set-key rename metadata help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init import export doctor help" -f -a "upgrade" -d 'Upgrade installed packages to their latest versions'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init import export doctor help" -f -a "list" -d 'List installed packages and their metadata'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init import export doctor help" -f -a "probe" -d 'Inspect releases visible from a provider without installing'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init import export doctor help" -f -a "config" -d 'Manage upstream configuration'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init import export doctor help" -f -a "package" -d 'Manage package-specific settings and metadata'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init import export doctor help" -f -a "init" -d 'Initialize upstream by adding it to your shell PATH'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init import export doctor help" -f -a "import" -d 'Import packages from a manifest or full snapshot'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init import export doctor help" -f -a "export" -d 'Export packages to a manifest or full snapshot'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init import export doctor help" -f -a "doctor" -d 'Run diagnostics to detect installation and integration issues'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init import export doctor help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
