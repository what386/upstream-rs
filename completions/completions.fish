...
complete -c upstream -n "__fish_upstream_using_subcommand init" -l check -d 'Check initialization status without making changes'
...
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init hooks import export doctor help" -f -a "install" -d 'Install a package from an upstream release source'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init hooks import export doctor help" -f -a "remove" -d 'Remove one or more installed packages'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init hooks import export doctor help" -f -a "upgrade" -d 'Upgrade installed packages to their latest versions'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init hooks import export doctor help" -f -a "list" -d 'List installed packages and their metadata'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init hooks import export doctor help" -f -a "probe" -d 'Inspect releases visible from a provider without installing'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init hooks import export doctor help" -f -a "config" -d 'Manage upstream configuration'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init hooks import export doctor help" -f -a "package" -d 'Manage package-specific settings and metadata'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init hooks import export doctor help" -f -a "init" -d 'Initialize upstream by adding it to your shell PATH'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init hooks import export doctor help" -f -a "hooks" -d 'Manage shell integration hooks and local upstream data'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init hooks import export doctor help" -f -a "import" -d 'Import packages from a manifest or full snapshot'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init hooks import export doctor help" -f -a "export" -d 'Export packages to a manifest or full snapshot'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init hooks import export doctor help" -f -a "doctor" -d 'Run diagnostics to detect installation and integration issues'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install remove upgrade list probe config package init hooks import export doctor help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
