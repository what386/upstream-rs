...
function __fish_upstream_global_optspecs
    string join \n y/yes no-pager h/help V/version
end
...
complete -c upstream -n "__fish_upstream_needs_command" -f -a "config" -d 'View and edit config.toml'
complete -c upstream -n "__fish_upstream_needs_command" -f -a "auth" -d 'View and edit auth.toml'
complete -c upstream -n "__fish_upstream_needs_command" -f -a "package" -d 'Manage installed package records and launcher entries'
complete -c upstream -n "__fish_upstream_needs_command" -f -a "cache" -d 'Inspect or remove reusable cached data'
...
complete -c upstream -n "__fish_upstream_using_subcommand install" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand build" -s v -l semver -d 'Semantic version to resolve to a release tag' -r
...
complete -c upstream -n "__fish_upstream_using_subcommand build" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand remove" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand uninstall" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand reinstall" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand upgrade" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand list" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand info" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand changelog" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand docs" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand probe" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand search" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand find" -l no-pager -d 'Prevent paging long command outputs'
complete -c upstream -n "__fish_upstream_using_subcommand find" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c upstream -n "__fish_upstream_using_subcommand config; and not __fish_seen_subcommand_from set get list edit reset help" -s y -l yes -d 'Accept confirmation prompts automatically'
complete -c upstream -n "__fish_upstream_using_subcommand config; and not __fish_seen_subcommand_from set get list edit reset help" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand config; and not __fish_seen_subcommand_from set get list edit reset help" -f -a "list" -d 'List current configuration values'
complete -c upstream -n "__fish_upstream_using_subcommand config; and not __fish_seen_subcommand_from set get list edit reset help" -f -a "edit" -d 'Open config.toml in your default editor'
complete -c upstream -n "__fish_upstream_using_subcommand config; and not __fish_seen_subcommand_from set get list edit reset help" -f -a "reset" -d 'Reset config.toml to defaults'
...
complete -c upstream -n "__fish_upstream_using_subcommand config; and __fish_seen_subcommand_from set" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand config; and __fish_seen_subcommand_from get" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand config; and __fish_seen_subcommand_from list" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand config; and __fish_seen_subcommand_from edit" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand config; and __fish_seen_subcommand_from reset" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand auth; and not __fish_seen_subcommand_from set get list edit reset help" -s y -l yes -d 'Accept confirmation prompts automatically'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and not __fish_seen_subcommand_from set get list edit reset help" -l no-pager -d 'Prevent paging long command outputs'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and not __fish_seen_subcommand_from set get list edit reset help" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and not __fish_seen_subcommand_from set get list edit reset help" -f -a "set" -d 'Set provider API tokens'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and not __fish_seen_subcommand_from set get list edit reset help" -f -a "get" -d 'Get provider API tokens'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and not __fish_seen_subcommand_from set get list edit reset help" -f -a "list" -d 'List current provider API tokens'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and not __fish_seen_subcommand_from set get list edit reset help" -f -a "edit" -d 'Open auth.toml in your default editor'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and not __fish_seen_subcommand_from set get list edit reset help" -f -a "reset" -d 'Reset auth.toml to defaults'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and not __fish_seen_subcommand_from set get list edit reset help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from set" -s y -l yes -d 'Accept confirmation prompts automatically'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from set" -l no-pager -d 'Prevent paging long command outputs'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from set" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from get" -s y -l yes -d 'Accept confirmation prompts automatically'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from get" -l no-pager -d 'Prevent paging long command outputs'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from get" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from list" -s y -l yes -d 'Accept confirmation prompts automatically'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from list" -l no-pager -d 'Prevent paging long command outputs'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from list" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from edit" -s y -l yes -d 'Accept confirmation prompts automatically'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from edit" -l no-pager -d 'Prevent paging long command outputs'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from edit" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from reset" -s y -l yes -d 'Accept confirmation prompts automatically'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from reset" -l no-pager -d 'Prevent paging long command outputs'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from reset" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from help" -f -a "set" -d 'Set provider API tokens'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from help" -f -a "get" -d 'Get provider API tokens'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from help" -f -a "list" -d 'List current provider API tokens'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from help" -f -a "edit" -d 'Open auth.toml in your default editor'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from help" -f -a "reset" -d 'Reset auth.toml to defaults'
complete -c upstream -n "__fish_upstream_using_subcommand auth; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from set get unset pin unpin rename add-entry rm-entry help" -s y -l yes -d 'Accept confirmation prompts automatically'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from set get unset pin unpin rename add-entry rm-entry help" -l no-pager -d 'Prevent paging long command outputs'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from set get unset pin unpin rename add-entry rm-entry help" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from set get unset pin unpin rename add-entry rm-entry help" -f -a "set" -d 'Set user-controlled settings for an installed package'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from set get unset pin unpin rename add-entry rm-entry help" -f -a "get" -d 'Show user-controlled settings for an installed package'
...
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from set" -s y -l yes -d 'Accept confirmation prompts automatically'
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from set" -l no-pager -d 'Prevent paging long command outputs'
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from set" -s h -l help -d 'Print help'
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from get" -l json -d 'Print settings as JSON'
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from get" -s y -l yes -d 'Accept confirmation prompts automatically'
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from get" -l no-pager -d 'Prevent paging long command outputs'
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from get" -s h -l help -d 'Print help'
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from unset" -s y -l yes -d 'Accept confirmation prompts automatically'
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from unset" -l no-pager -d 'Prevent paging long command outputs'
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from unset" -s h -l help -d 'Print help'
...
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from pin" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from unpin" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from rename" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from add-entry" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from rm-entry" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from help" -f -a "set" -d 'Set user-controlled settings for an installed package'
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from help" -f -a "get" -d 'Show user-controlled settings for an installed package'
...
complete -c upstream -n "__fish_upstream_using_subcommand cache; and not __fish_seen_subcommand_from list clean help" -s y -l yes -d 'Accept confirmation prompts automatically'
complete -c upstream -n "__fish_upstream_using_subcommand cache; and not __fish_seen_subcommand_from list clean help" -l no-pager -d 'Prevent paging long command outputs'
complete -c upstream -n "__fish_upstream_using_subcommand cache; and not __fish_seen_subcommand_from list clean help" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c upstream -n "__fish_upstream_using_subcommand cache; and not __fish_seen_subcommand_from list clean help" -f -a "list" -d 'Show known cache categories and their disk usage'
complete -c upstream -n "__fish_upstream_using_subcommand cache; and not __fish_seen_subcommand_from list clean help" -f -a "clean" -d 'Remove known cache categories'
complete -c upstream -n "__fish_upstream_using_subcommand cache; and not __fish_seen_subcommand_from list clean help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c upstream -n "__fish_upstream_using_subcommand cache; and __fish_seen_subcommand_from list" -l json -d 'Print cache information as JSON'
complete -c upstream -n "__fish_upstream_using_subcommand cache; and __fish_seen_subcommand_from list" -s y -l yes -d 'Accept confirmation prompts automatically'
complete -c upstream -n "__fish_upstream_using_subcommand cache; and __fish_seen_subcommand_from list" -l no-pager -d 'Prevent paging long command outputs'
complete -c upstream -n "__fish_upstream_using_subcommand cache; and __fish_seen_subcommand_from list" -s h -l help -d 'Print help'
complete -c upstream -n "__fish_upstream_using_subcommand cache; and __fish_seen_subcommand_from clean" -l dry-run -d 'Preview cache cleanup without deleting anything'
complete -c upstream -n "__fish_upstream_using_subcommand cache; and __fish_seen_subcommand_from clean" -s y -l yes -d 'Accept confirmation prompts automatically'
complete -c upstream -n "__fish_upstream_using_subcommand cache; and __fish_seen_subcommand_from clean" -l no-pager -d 'Prevent paging long command outputs'
complete -c upstream -n "__fish_upstream_using_subcommand cache; and __fish_seen_subcommand_from clean" -s h -l help -d 'Print help'
complete -c upstream -n "__fish_upstream_using_subcommand cache; and __fish_seen_subcommand_from help" -f -a "list" -d 'Show known cache categories and their disk usage'
complete -c upstream -n "__fish_upstream_using_subcommand cache; and __fish_seen_subcommand_from help" -f -a "clean" -d 'Remove known cache categories'
complete -c upstream -n "__fish_upstream_using_subcommand cache; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c upstream -n "__fish_upstream_using_subcommand hooks; and not __fish_seen_subcommand_from init check clean purge help" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand hooks; and __fish_seen_subcommand_from init" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand hooks; and __fish_seen_subcommand_from check" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand hooks; and __fish_seen_subcommand_from clean" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand hooks; and __fish_seen_subcommand_from purge" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand import; and not __fish_seen_subcommand_from config keys packages profile help" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand import; and __fish_seen_subcommand_from config" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand export; and not __fish_seen_subcommand_from config keys packages profile help" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand export; and __fish_seen_subcommand_from config" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand export; and __fish_seen_subcommand_from keys" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand export; and __fish_seen_subcommand_from packages" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand export; and __fish_seen_subcommand_from profile" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand history" -l package -d 'Only show records for this package' -r
complete -c upstream -n "__fish_upstream_using_subcommand history" -l action -d 'Only show operations whose action begins with this value' -r
complete -c upstream -n "__fish_upstream_using_subcommand history" -l status -d 'Only show this status (success, failed, warning, or cancelled)' -r
complete -c upstream -n "__fish_upstream_using_subcommand history" -l limit -d 'Maximum number of matching operations to show' -r
complete -c upstream -n "__fish_upstream_using_subcommand history" -l since -d 'Only show operations newer than a duration such as 2d, 12h, or 30m' -r
complete -c upstream -n "__fish_upstream_using_subcommand history" -l today -d 'Only show operations from the local calendar day'
complete -c upstream -n "__fish_upstream_using_subcommand history" -l json -d 'Print matching records as JSON'
complete -c upstream -n "__fish_upstream_using_subcommand history" -s y -l yes -d 'Accept confirmation prompts automatically'
complete -c upstream -n "__fish_upstream_using_subcommand history" -l no-pager -d 'Prevent paging long command outputs'
complete -c upstream -n "__fish_upstream_using_subcommand history" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "install" -d 'Install a release asset or direct download'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "build" -d 'Build and install a package from source'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "remove" -d 'Remove installed package files and metadata'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "reinstall" -d 'Reinstall packages from their stored source metadata'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "upgrade" -d 'Check for or install package updates'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "list" -d 'List installed packages'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "info" -d 'Show details for one installed package'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "changelog" -d 'Show release notes for an installed package'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "docs" -d 'Search cached or fetched package README docs'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "probe" -d 'Inspect releases, choose an asset, and install it'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "search" -d 'Search provider repositories without installing'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "find" -d 'Search repositories interactively and install one'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "config" -d 'View and edit config.toml'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "auth" -d 'View and edit auth.toml'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "package" -d 'Manage installed package records and launcher entries'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "cache" -d 'Inspect or remove reusable cached data'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "hooks" -d 'Manage shell PATH hooks and local upstream data'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "import" -d 'Import config, trust keys, packages, or a profile'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "export" -d 'Export config, trust keys, packages, or a profile'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "history" -d 'Show recent grouped operation history'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "doctor" -d 'Run diagnostics to detect installation and integration issues'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove reinstall upgrade list info changelog docs probe search find config auth package cache hooks import export history doctor help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c upstream -n "__fish_upstream_using_subcommand help; and __fish_seen_subcommand_from auth" -f -a "set" -d 'Set provider API tokens'
complete -c upstream -n "__fish_upstream_using_subcommand help; and __fish_seen_subcommand_from auth" -f -a "get" -d 'Get provider API tokens'
complete -c upstream -n "__fish_upstream_using_subcommand help; and __fish_seen_subcommand_from auth" -f -a "list" -d 'List current provider API tokens'
complete -c upstream -n "__fish_upstream_using_subcommand help; and __fish_seen_subcommand_from auth" -f -a "edit" -d 'Open auth.toml in your default editor'
complete -c upstream -n "__fish_upstream_using_subcommand help; and __fish_seen_subcommand_from auth" -f -a "reset" -d 'Reset auth.toml to defaults'
complete -c upstream -n "__fish_upstream_using_subcommand help; and __fish_seen_subcommand_from package" -f -a "set" -d 'Set user-controlled settings for an installed package'
complete -c upstream -n "__fish_upstream_using_subcommand help; and __fish_seen_subcommand_from package" -f -a "get" -d 'Show user-controlled settings for an installed package'
...
complete -c upstream -n "__fish_upstream_using_subcommand help; and __fish_seen_subcommand_from cache" -f -a "clean" -d 'Remove known cache categories'
