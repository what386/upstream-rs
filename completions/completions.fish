...
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin rename add-entry rm-entry help" -l no-pager -d 'Prevent paging long command outputs'
...
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list info changelog docs probe search find config auth package hooks import export doctor help" -f -a "install" -d 'Install a release asset or direct download'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list info changelog docs probe search find config auth package hooks import export doctor help" -f -a "build" -d 'Build and install a package from source'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list info changelog docs probe search find config auth package hooks import export doctor help" -f -a "remove" -d 'Remove installed package files and metadata'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list info changelog docs probe search find config auth package hooks import export doctor help" -f -a "rollback" -d 'Restore or prune stored rollback artifacts'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list info changelog docs probe search find config auth package hooks import export doctor help" -f -a "reinstall" -d 'Reinstall packages from their stored source metadata'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list info changelog docs probe search find config auth package hooks import export doctor help" -f -a "upgrade" -d 'Check for or install package updates'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list info changelog docs probe search find config auth package hooks import export doctor help" -f -a "list" -d 'List installed packages'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list info changelog docs probe search find config auth package hooks import export doctor help" -f -a "info" -d 'Show details for one installed package'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list info changelog docs probe search find config auth package hooks import export doctor help" -f -a "changelog" -d 'Show release notes for an installed package'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list info changelog docs probe search find config auth package hooks import export doctor help" -f -a "docs" -d 'Search cached or fetched package README docs'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list info changelog docs probe search find config auth package hooks import export doctor help" -f -a "probe" -d 'Inspect releases, choose an asset, and install it'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list info changelog docs probe search find config auth package hooks import export doctor help" -f -a "search" -d 'Search provider repositories without installing'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list info changelog docs probe search find config auth package hooks import export doctor help" -f -a "find" -d 'Search repositories interactively and install one'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list info changelog docs probe search find config auth package hooks import export doctor help" -f -a "config" -d 'View and edit config.toml'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list info changelog docs probe search find config auth package hooks import export doctor help" -f -a "auth" -d 'View and edit auth.toml'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list info changelog docs probe search find config auth package hooks import export doctor help" -f -a "package" -d 'Manage installed package records and launcher entries'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list info changelog docs probe search find config auth package hooks import export doctor help" -f -a "hooks" -d 'Manage shell PATH hooks and local upstream data'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list info changelog docs probe search find config auth package hooks import export doctor help" -f -a "import" -d 'Import config, trust keys, packages, or a profile'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list info changelog docs probe search find config auth package hooks import export doctor help" -f -a "export" -d 'Export config, trust keys, packages, or a profile'
