...
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin remove get-key set-key rename metadata help" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin remove get-key set-key rename metadata help" -f -a "pin" -d 'Pin a package to its current version'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin remove get-key set-key rename metadata help" -f -a "unpin" -d 'Unpin a package to allow updates'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin remove get-key set-key rename metadata help" -f -a "remove" -d 'Remove a package entry from upstream metadata'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin remove get-key set-key rename metadata help" -f -a "get-key" -d 'Get specific package metadata fields'
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin remove get-key set-key rename metadata help" -f -a "set-key" -d 'Manually set package metadata fields'
...
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from help" -f -a "remove" -d 'Remove a package entry from upstream metadata'
...
complete -c upstream -n "__fish_upstream_using_subcommand hooks; and __fish_seen_subcommand_from purge" -s y -l yes -d 'Skip the confirmation prompt'
...
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list probe search config package hooks import export doctor help" -f -a "install" -d 'Install a package from an upstream release source'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list probe search config package hooks import export doctor help" -f -a "build" -d 'Build and install from source for release tags without artifacts'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list probe search config package hooks import export doctor help" -f -a "remove" -d 'Remove one or more installed packages'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list probe search config package hooks import export doctor help" -f -a "rollback" -d 'Restore or prune stored rollback artifacts'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list probe search config package hooks import export doctor help" -f -a "reinstall" -d 'Reinstall one or more packages (remove then install)'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list probe search config package hooks import export doctor help" -f -a "upgrade" -d 'Upgrade installed packages to their latest versions'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list probe search config package hooks import export doctor help" -f -a "list" -d 'List installed packages and their metadata'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list probe search config package hooks import export doctor help" -f -a "probe" -d 'Inspect releases visible from a provider without installing'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list probe search config package hooks import export doctor help" -f -a "search" -d 'Search provider repositories by keyword(s)'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list probe search config package hooks import export doctor help" -f -a "config" -d 'Manage upstream configuration'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list probe search config package hooks import export doctor help" -f -a "package" -d 'Manage package-specific settings and metadata'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list probe search config package hooks import export doctor help" -f -a "hooks" -d 'Manage shell integration hooks and local upstream data'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list probe search config package hooks import export doctor help" -f -a "import" -d 'Import trusted keys, package metadata manifests, or full snapshots'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list probe search config package hooks import export doctor help" -f -a "export" -d 'Export packages to a manifest or full snapshot'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list probe search config package hooks import export doctor help" -f -a "doctor" -d 'Run diagnostics to detect installation and integration issues'
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list probe search config package hooks import export doctor help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c upstream -n "__fish_upstream_using_subcommand help; and __fish_seen_subcommand_from package" -f -a "remove" -d 'Remove a package entry from upstream metadata'
