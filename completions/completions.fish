...
complete -c upstream -n "__fish_upstream_using_subcommand package; and not __fish_seen_subcommand_from pin unpin remove get-key set-key rename metadata help" -s y -l yes -d 'Accept confirmation prompts'
...
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from remove" -s y -l yes -d 'Accept confirmation prompts'
...
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from get-key" -s y -l yes -d 'Accept confirmation prompts'
...
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from set-key" -s y -l yes -d 'Accept confirmation prompts'
...
complete -c upstream -n "__fish_upstream_using_subcommand package; and __fish_seen_subcommand_from metadata" -s y -l yes -d 'Accept confirmation prompts'
...
complete -c upstream -n "__fish_upstream_using_subcommand help; and not __fish_seen_subcommand_from install build remove rollback reinstall upgrade list changelog probe search config package hooks import export doctor help" -f -a "package" -d 'Manage package-specific settings and metadata'
