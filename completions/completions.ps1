...
Register-ArgumentCompleter -Native -CommandName 'upstream' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        ...
        'upstream;probe' {
            ...
            [CompletionResult]::new('--include-incompatible', '--include-incompatible', [CompletionResultType]::ParameterName, 'Include assets that do not match the current OS/architecture or resolved install file type')
